...
var Permissions = require('./preview/Permissions');  /* jshint ignore:line */
 ...
 * @property {Twilio.Preview.Permissions} permissions - permissions version
...
Object.defineProperty(Preview.prototype,
  'permissions', {
  get: function() {
    this._permissions = this._permissions || new Permissions(this);
