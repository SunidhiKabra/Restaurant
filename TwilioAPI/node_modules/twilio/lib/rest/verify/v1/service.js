...
ServiceList = function ServiceList(version) {
   ...
   *
   * @returns {Twilio.Verify.V1.ServiceContext}
   */
  /* jshint ignore:end */
   ...
   * @param {string} opts.friendlyName - Friendly name of the service
 ...
 * @property {string} friendlyName - Friendly name of the service
 ...
 *
 * @returns {Twilio.Verify.V1.ServiceContext.VerificationList}
 */
/* jshint ignore:end */
 ...
 *
 * @returns {Twilio.Verify.V1.ServiceContext.VerificationCheckList}
 */
/* jshint ignore:end */
 ...
 * Initialize the ServiceContextPLEASE NOTE that this class contains beta products that are subject to change. Use them with caution.
 *
 * @property {Twilio.Verify.V1.ServiceContext.VerificationList} verifications -
 *          verifications resource
 * @property {Twilio.Verify.V1.ServiceContext.VerificationCheckList} verificationChecks -
