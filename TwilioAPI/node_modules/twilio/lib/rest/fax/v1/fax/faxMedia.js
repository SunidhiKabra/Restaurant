 ...
 *
 * @property {string} sid - A string that uniquely identifies this fax media
 * @property {string} accountSid - Account SID
 * @property {string} faxSid - Fax SID
 * @property {string} contentType - Media content type
 * @property {Date} dateCreated - The date this fax media was created
 * @property {Date} dateUpdated - The date this fax media was updated
 * @property {string} url - The URL of this resource
 *
 * @param {V1} version - Version of the resource
 * @param {FaxMediaPayload} payload - The instance payload
 * @param {sid} faxSid - Fax SID
...
FaxMediaContext = function FaxMediaContext(version, faxSid, sid) {
  ...
  this._uri = _.template(
    '/Faxes/<%= faxSid %>/Media/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
