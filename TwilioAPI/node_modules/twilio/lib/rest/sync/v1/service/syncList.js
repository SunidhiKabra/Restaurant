 ...
 *
 * @property {string} sid - The unique 34-character SID identifier of the List.
 * @property {string} uniqueName - The unique and addressable name of this List.
 * @property {string} accountSid - The unique SID identifier of the Twilio Account.
 * @property {string} serviceSid -
 *          The unique SID identifier of the Service Instance that hosts this List object.
 * @property {string} url - The absolute URL for this List.
 ...
 * @property {string} createdBy - The identity of the List creator.
 *
 * @param {V1} version - Version of the resource
