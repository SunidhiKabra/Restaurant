...
ExecutionStepList = function ExecutionStepList(version, flowSid, executionSid) {
  ...
  ExecutionStepListInstance._uri = _.template(
    '/Flows/<%= flowSid %>/Executions/<%= executionSid %>/Steps' // jshint ignore:line
  )(ExecutionStepListInstance._solution);
  /* jshint ignore:start */
  /**
...
ExecutionStepContext = function ExecutionStepContext(version, flowSid,
  ...
  this._uri = _.template(
    '/Flows/<%= flowSid %>/Executions/<%= executionSid %>/Steps/<%= sid %>' // jshint ignore:line
  )(this._solution);
