...
BulkCountryUpdateList = function BulkCountryUpdateList(version) {
   ...
   *
   * @returns {Twilio.Preview.Permissions.VoicePermissionContext.BulkCountryUpdateContext}
   */
  /* jshint ignore:end */
  ...
  BulkCountryUpdateListInstance._uri = _.template(
    '/VoicePermissions/BulkCountryUpdates' // jshint ignore:line
  )(BulkCountryUpdateListInstance._solution);
  /* jshint ignore:start */
  /**
   ...
   * @param {string} opts.updateRequest - Json list of update objects
 ...
 *
 * @property {number} updateCount - The number of countries successfully updated
 * @property {string} updateRequest - The update_request
 *
 * @param {Permissions} version - Version of the resource
