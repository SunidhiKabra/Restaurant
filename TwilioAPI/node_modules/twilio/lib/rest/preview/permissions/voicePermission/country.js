...
CountryList = function CountryList(version) {
   ...
   *
   * @returns {Twilio.Preview.Permissions.VoicePermissionContext.CountryContext}
   */
  /* jshint ignore:end */
  ...
  CountryListInstance._uri = _.template(
    '/VoicePermissions/Countries' // jshint ignore:line
  )(CountryListInstance._solution);
  /* jshint ignore:start */
  /**
   ...
   * @param {string} [opts.isoCode] - The ISO country code
   * @param {string} [opts.continent] - Filter the results by specified continent
   * @param {string} [opts.countryCode] - country codes
 ...
 * @property {string} countryCodes - The list of country codes
 ...
 *
 * @returns {Twilio.Preview.Permissions.VoicePermissionContext.CountryContext.HighriskSpecialPrefixList}
 */
/* jshint ignore:end */
 ...
 * Initialize the CountryContextPLEASE NOTE that this class contains preview products that are subject to change. Use them with caution. If you currently do not have developer preview access, please contact help@twilio.com.
 *
 * @property {Twilio.Preview.Permissions.VoicePermissionContext.CountryContext.HighriskSpecialPrefixList} highriskSpecialPrefixes -
...
CountryContext = function CountryContext(version, isoCode) {
  ...
  this._uri = _.template(
    '/VoicePermissions/Countries/<%= isoCode %>' // jshint ignore:line
  )(this._solution);
