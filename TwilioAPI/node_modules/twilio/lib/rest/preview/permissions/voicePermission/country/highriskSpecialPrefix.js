 ...
 */
/* jshint ignore:end */
HighriskSpecialPrefixList = function HighriskSpecialPrefixList(version,
    parentIsoCode) {
  /* jshint ignore:start */
  /**
   * @param {string} sid - sid of instance
   *
   * @returns {Twilio.Preview.Permissions.VoicePermissionContext.CountryContext.HighriskSpecialPrefixContext}
   */
  /* jshint ignore:end */
  ...
  // Path Solution
  HighriskSpecialPrefixListInstance._solution = {parentIsoCode: parentIsoCode};
  HighriskSpecialPrefixListInstance._uri = _.template(
    '/VoicePermissions/Countries/<%= parentIsoCode %>/HighRiskSpecialPrefixes' // jshint ignore:line
...
HighriskSpecialPrefixPage.prototype.getInstance = function getInstance(payload)
    {
  return new HighriskSpecialPrefixInstance(this._version, payload, this._solution.parentIsoCode);
};
...
HighriskSpecialPrefixInstance = function HighriskSpecialPrefixInstance(version,
  ...
  this._solution = {parentIsoCode: parentIsoCode, };
};
