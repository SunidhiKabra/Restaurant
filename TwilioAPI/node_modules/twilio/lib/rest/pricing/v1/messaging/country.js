...
CountryList = function CountryList(version) {
  ...
  CountryListInstance._uri = _.template(
    '/Messaging/Countries' // jshint ignore:line
  )(CountryListInstance._solution);
  /* jshint ignore:start */
  /**
 ...
 * @property {string} outboundSmsPrices - List of OutboundSMSPrice records
 * @property {string} inboundSmsPrices - List of InboundPrice records
...
CountryContext = function CountryContext(version, isoCountry) {
  ...
  this._uri = _.template(
    '/Messaging/Countries/<%= isoCountry %>' // jshint ignore:line
  )(this._solution);
};
