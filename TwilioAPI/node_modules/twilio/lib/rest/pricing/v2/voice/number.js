 ...
 *
 * @property {string} destinationNumber - The destination phone number, in E.164
 * @property {string} originationNumber - The origination phone number, in E.164
 ...
 * @property {string} inboundCallPrice - List of InboundCallPrice records
 ...
 * @param {phone_number} destinationNumber - Fetches voice prices for number
 */
/* jshint ignore:end */
 ...
 * @param {string} [opts.originationNumber] - The origination_number
...
NumberContext = function NumberContext(version, destinationNumber) {
  ...
  this._uri = _.template(
    '/Voice/Numbers/<%= destinationNumber %>' // jshint ignore:line
  )(this._solution);
};
