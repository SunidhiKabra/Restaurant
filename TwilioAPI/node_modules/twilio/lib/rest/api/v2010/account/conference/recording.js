...
RecordingList = function RecordingList(version, accountSid, conferenceSid) {
  ...
  RecordingListInstance._uri = _.template(
    '/Accounts/<%= accountSid %>/Conferences/<%= conferenceSid %>/Recordings.json' // jshint ignore:line
...
RecordingContext = function RecordingContext(version, accountSid, conferenceSid,
  ...
  this._uri = _.template(
    '/Accounts/<%= accountSid %>/Conferences/<%= conferenceSid %>/Recordings/<%= sid %>.json' // jshint ignore:line
  )(this._solution);
};
