...
interface MonthlyListInstance {
   ...
   */
  each(opts?: MonthlyListInstanceEachOptions, callback?: (item: MonthlyInstance, done: (err?: Error) => void) => void): void;
  /**
 ...
 */
interface MonthlyListInstanceEachOptions {
 ...
 * @property startDate - Only include usage that has occurred on or after this date.
 */
interface MonthlyListInstanceOptions {
  category?: MonthlyCategory;
  endDate?: Date;
  includeSubaccounts?: boolean;
  limit?: number;
 ...
 * @property startDate - Only include usage that has occurred on or after this date.
 */
interface MonthlyListInstancePageOptions {
  category?: MonthlyCategory;
  endDate?: Date;
  includeSubaccounts?: boolean;
  pageNumber?: number;
